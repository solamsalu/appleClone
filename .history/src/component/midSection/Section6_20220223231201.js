          ...
          <div className="eighth-highlight-wrapper mt-2 ">
            ...
            <div className="col-12 text-center">
              <div className="tv-plus-logo pt-5 pt-md-4">
                <img src={arcade} alt="apple tv logo "></img>
              </div>
              ...
              <div className="arcade-links links-wrapper text-center pr-3">
                <ul>
                  <li className="list-unstyled pb-1 "><a href="">Play now<sup>2</sup></a></li>
                  <a className="" href="">Learn about Apple</a>
                  <li className="list-unstyled py-2 "><a href="">Arcade</a></li>
                </ul>
              </div>
            </div>
          </div>
          ...
          <div className=" ninth-highlight-wrapper mt-2 ">
            ...
            <div className=" ">
              ...
              <div className="arcade-links links-wrapper text-center pr-4 ">
                <ul>
                  <li className="list-unstyled pb-0"><a href="">Learn more</a></li>
                  <li className="list-unstyled "><a href="">Apply now</a></li>
                </ul>
              </div>
            </div>
          </div>
