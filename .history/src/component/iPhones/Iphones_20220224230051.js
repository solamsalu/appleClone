			...
			{product.map((el) => {
				...
				return (
					<div className="row mb-2">
						{/*Contains everything*/}
						<div className={`col-sm-12 col-md-6 pr-2 pt-5 black-reverse order-${order1}`}>
						...
						{/*left side*/}
						<div className={`col-sm-12 col-md-6 beige  order-${order2}`}>
							{/*right side*/}
							<img className="img-fluid" src={el.product_img} alt="iphone" />
						</div>
					</div>
				);
			})}
