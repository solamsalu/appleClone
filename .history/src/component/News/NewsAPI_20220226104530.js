...
const NewsAPI = () => {
	...
	useEffect(() => {
		fetch(
			'https://newsapi.org/v2/everything?q=en&%22Apple%22&from=2022-02-23&to=2022-02-23&sortBy=publishedAt&totalResults=6&apiKey=178021481aed4bf9a6c04e84c70235f8'
		)
